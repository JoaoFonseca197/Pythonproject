...
def main():
    ...
    comp=[]
    #fazer shuffle
    cores = [azul,azul,verde,verde,vermelho,vermelho,lilas,lilas,azul_claro,azul_claro,laranja,laranja,rosa,rosa,verde_ranho,verde_ranho,castanho,castanho,rosa_maduro,rosa_maduro]
    ...
    Cartas = [False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False]

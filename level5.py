...
def main():
    ...
    rosa_choque =(226 16 226)
    vermelho_dinamite =(226,16,28)
    cont= 0
    penalização = 0
    score = 0
    i= 0
    comp=[]
    #fazer shuffle
    cores = [vermelho_dinamite,vermelho_dinamite,rosa_choque,rosa_choque,verde_toxico,verde_toxico,azul_marinho,azul_marinho,azul,azul,verde,verde,vermelho,vermelho,lilas,lilas,azul_claro,azul_claro,laranja,laranja,rosa,rosa,verde_ranho,verde_ranho,castanho,castanho,rosa_maduro,rosa_maduro]
    ...
    C17 = Carta((255,255,0),(265,100,70,100))
    C18= Carta((255,255,0),(265,210,70,100))
    C19= Carta((255,255,0),(265,320,70,100))
    C20= Carta((255,255,0),(265,430,70,100))
    C21 = Carta((255,255,0),(165,100,70,100))
    C22= Carta((255,255,0),(165,210,70,100))
    C23= Carta((255,255,0),(165,320,70,100))
    C24= Carta((255,255,0),(165,430,70,100))
    C25 = Carta((255,255,0),(65,100,70,100))
    C26= Carta((255,255,0),(65,210,70,100))
    C27= Carta((255,255,0),(65,320,70,100))
    C28= Carta((255,255,0),(65,430,70,100))
    C29= Carta((255,255,0),(65,530,70,100))
    C30= Carta((255,255,0),(65,630,70,100))
    
    #Se elas já foram "viradas" ou não
    Cartas = [False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False]
    ...
    while(True):
        ...
        pygame.draw.rect(screen,C13.color, (265,100,70,100), 0)
        pygame.draw.rect(screen,C14.color, (265,210,70,100), 0)
        pygame.draw.rect(screen,C15.color, (265,320,70,100), 0)
        pygame.draw.rect(screen,C16.color, (265,430,70,100), 0)
